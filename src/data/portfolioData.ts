...
const portfolioData: PortfolioData = {
  name: "עמית אלגלי",
  title: "במאי ועורך",
  bio: "במאי ועורך מקצועי המתמחה בסיפורי נרטיב, פרסומות וקליפים.",
  topics: [
    {
      id: "commercials",
      name: "פרסומות",
      description: "סרטוני פרסום למותגים ומוצרים"
    },
    {
      id: "narrative",
      name: "סיפורי נרטיב",
      description: "סיפורים נרטיביים וסרטים קצרים"
    },
    {
      id: "music-videos",
      name: "קליפים",
      description: "קליפים עבור אמנים שונים"
    }
  ],
  videos: [
    {
